...
describe('Ground truth — project counts (sanity checks)', () => {
  ...
  it('src/lib/: 110 JS modules at top level (safe-fs + regex-utils added for LH1 choke points)', () => {
    assert.equal(countTopLevelJs('src/lib'), 110);
  });
...
describe('README — explicit numeric claims match reality', () => {
  ...
  it('Project structure: 110 JS modules in src/lib', () => {
    assert.match(README, /110 JS modules/);
  });
