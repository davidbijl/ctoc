...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-6.9.81-blue">
...
│   ├── lib/         106 JS modules (planning, quality, refinement, dispatcher, regulatory-regime, audit-chain, retention, legal-hold, traceability, lineage, eval-harness, comparator, stale-detector)
...
**6.9.81** · Built by [@robotijn](https://github.com/robotijn)
