...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-6.9.110-blue">
...
Until you choose one, the dashboard **asks you which environment to use** — as an extra question alongside the normal plan overview, never replacing it. You can change it anytime in **System → Settings** (`general.environment` in `.ctoc/settings.json`).
...
│   ├── lib/         113 JS modules (planning, quality, refinement, dispatcher, regulatory-regime, audit-chain, retention, legal-hold, traceability, lineage, eval-harness, comparator, stale-detector, stale-cleanup, claude-md-lessons, safe-fs, regex-utils, task-registry, task-view, notes)
...
**6.9.110** · Built by [@robotijn](https://github.com/robotijn)
