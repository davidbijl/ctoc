...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-6.9.105-blue">
...
│   ├── lib/         111 JS modules (planning, quality, refinement, dispatcher, regulatory-regime, audit-chain, retention, legal-hold, traceability, lineage, eval-harness, comparator, stale-detector, stale-cleanup, claude-md-lessons, safe-fs, regex-utils, task-registry)
...
**6.9.105** · Built by [@robotijn](https://github.com/robotijn)
